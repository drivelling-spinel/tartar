...
// Start Eternity TC New Sprites
  ...
  "MNTR", "FX12", "FX13", "FX04", "TRE4", "TRE5", "TRE6", "TRDT", "MSS1",
  "MSS2", "CLER", "CBAL", "FBUL", "SPSH", "SLDG", "FOGS", "FOGM", "FOGL",
  "LCLR", "BRPL", "BARL", "TST0", "TST1", "ARMR", "STM1", "STM2", "SKH1",
  "GAR8", "GAR4", "WTRH", "CHDL", "MSH2", "CDRN", "TST2", "SWMV", "CPS5",
  "CPS6", "CPS1", "CPS4", "TMS6", "TMS1", "TMS5", "RCK1", "RCK4", "TST6",
  "TST7", "DWRF", "GRD1", "CYBN", "FDWF", "GRLN", "GREN", "GRNP", "PNS2",
  "CAXE", "CSTF", "TGLT", "ABK1", "KEY1", "KEY2", "KEY3", "KEY4", "KEY5",
  "KEY6", "KEY7", "KEY8", "KEY9", "KEYA", "KEYB", "NSPD", "FX15", "MUMM",
  "LVAS",
...
void A_AmbSound();        // ambient sound function
void A_ColgSound();       // ambient sound collages
void A_ClericAtk();       // cleric attack
void A_SetInvulnerability();   // MF2_INVULNERABILITY utility functions
void A_UnSetInvulnerability();
void A_FogSpawn();        // fog spawning functions
void A_FogMove();
void A_GhostOn();         // toggles translucency
void A_GhostOff();
void A_HideThing();       // toggles total invisibility by disabling visprite
void A_UnHideThing();
void A_BlurOn();
void A_BlurOff();
...
void A_MummyHeadScream(); // Halif's pet golem :)
void A_MummyAttack();
void A_MummySoul();
...
#define OLDBFG_8FRAMES(x) OLDBFG_4FRAMES(x) OLDBFG_4FRAMES(x+4)
  ...
  {SPR_TNT1,0,120,A_AmbSound,S_SND_WIND}, // S_SND_WIND    100
  {SPR_TNT1,0,90,A_AmbSound,S_SND_WATER}, // S_SND_WATER    85
  {SPR_TNT1,0,82,A_AmbSound,S_SND_WATERFL}, // S_SND_WATERFL
  {SPR_TNT1,0,14,A_AmbSound,S_SND_LAUGH1},  // S_SND_LAUGH1
  {SPR_TNT1,0,34,A_AmbSound,S_SND_DRIP},    // S_SND_DRIP
  {SPR_TNT1,0,105,A_ColgSound,S_SND_FOREST}, // S_SND_FOREST
  {SPR_TNT1,0,105,A_ColgSound,S_SND_SWAMP},  // S_SND_SWAMP
  // End Ambient Sounds
  // Start Trees
  {SPR_TRE3,0,-1,NULL,S_NULL},  // S_TRE3_1
  {SPR_TRE4,0,-1,NULL,S_NULL},  // S_TRE4_1
  {SPR_TRE5,0,-1,NULL,S_NULL},  // S_TRE5_1
  {SPR_TRDT,0,32,NULL,S_TRDT_1}, // S_TRDT_1 -- keep looping
  {SPR_TRDT,1,8,A_Scream,S_TRDT_DTH2},  // S_TRDT_DTH1
  {SPR_TRDT,2,8,NULL,S_TRDT_DTH3},      // S_TRDT_DTH2
  {SPR_TRDT,3,8,NULL,S_TRDT_DTH4},      // S_TRDT_DTH3
  {SPR_TRDT,4,8,NULL,S_TRDT_DTH5},      // S_TRDT_DTH4
  {SPR_TRDT,5,8,A_Fall,S_TRDT_DTH6},    // S_TRDT_DTH5
  {SPR_TRDT,6,-1,NULL,S_NULL},          // S_TRDT_DTH6
  // End Trees
  {SPR_MSS1,0,-1,NULL,S_NULL},  // S_MOSS1
  {SPR_MSS2,0,-1,NULL,S_NULL},  // S_MOSS2
  ...
  {SPR_FBUL,32768,4,NULL,S_ZFIREBULL2}, // S_ZFIREBULL1
  {SPR_FBUL,32769,4,NULL,S_ZFIREBULL3}, // S_ZFIREBULL2
  {SPR_FBUL,32770,4,NULL,S_ZFIREBULL4}, // S_ZFIREBULL3
  {SPR_FBUL,32771,4,NULL,S_ZFIREBULL5}, // S_ZFIREBULL4
  {SPR_FBUL,32772,4,NULL,S_ZFIREBULL6}, // S_ZFIREBULL5
  {SPR_FBUL,32773,4,NULL,S_ZFIREBULL7}, // S_ZFIREBULL6
  {SPR_FBUL,32774,4,NULL,S_ZFIREBULL1}, // S_ZFIREBULL7
  {SPR_FBUL,7,-1,NULL,S_NULL},          // S_ZFIREBULL_U
  ...
  {SPR_TNT1,0,100,A_AmbSound,S_SND_BUBBLE},  // S_SND_BUBBLE
  {SPR_TNT1,0,151,A_AmbSound,S_SND_SHLURP},  // S_SND_SHLURP
  {SPR_TNT1,0,103,A_AmbSound,S_SND_ROCKS},   // S_SND_ROCKS
  ...
  {SPR_TST0,0,-1,NULL,S_NULL},  // S_TABLESTUFF1
  {SPR_TST1,0,-1,NULL,S_NULL},  // S_TABLESTUFF2
  {SPR_ARMR,0,-1,NULL,S_NULL},  // S_SUITOFARMOR
  {SPR_STM1,0,-1,NULL,S_NULL},  // S_TREESTUMP1
  {SPR_STM2,0,-1,NULL,S_NULL},  // S_TREESTUMP2
  {SPR_SKH1,0,-1,NULL,S_NULL},  // S_HANGINGSKULL
  {SPR_GAR8,0,-1,NULL,S_NULL},  // S_SHORTGARGOYLE
  {SPR_GAR4,0,-1,NULL,S_NULL},  // S_TALLGARGOYLE
  ...
  {SPR_MSH2,0,-1,NULL,S_NULL},  // S_BIGSHROOM
  {SPR_CDRN,0,-1,NULL,S_NULL},  // S_CAULDRON_U
  {SPR_TST2,0,-1,NULL,S_NULL},  // S_TABLESTUFF3
  {SPR_SWMV,0,-1,NULL,S_NULL},  // S_SWAMPVINE
  {SPR_CPS5,0,-1,NULL,S_NULL},  // S_CORPSEHANGINGMANGLED
  {SPR_CPS6,0,-1,NULL,S_NULL},  // S_CORPSESITTING
  {SPR_CPS1,0,-1,NULL,S_NULL},  // S_CORPSEIMPALED
  {SPR_CPS4,0,-1,NULL,S_NULL},  // S_CORPSEHANGING
  {SPR_TMS6,0,-1,NULL,S_NULL},  // S_TOMBSTONETALL
  {SPR_TMS1,0,-1,NULL,S_NULL},  // S_TOMBSTONERIP
  {SPR_TMS5,0,-1,NULL,S_NULL},  // S_TOMBSTONEANKH
  {SPR_RCK1,0,-1,NULL,S_NULL},  // S_ROCKSMALL
  {SPR_RCK4,0,-1,NULL,S_NULL},  // S_ROCKLARGE
  {SPR_TST6,0,-1,NULL,S_NULL},  // S_TABLESTUFF4
  {SPR_TST7,0,-1,NULL,S_NULL},  // S_TABLESTUFF5
  {SPR_GRD1,0,-1,NULL,S_NULL},  // S_GUARD1STAND
  ...
  {SPR_DWRF,0,-1,NULL,S_NULL},          // S_DWARF1TALK1  dialog dwarf
  {SPR_GRD1,0,-1,NULL,S_NULL},          // S_GUARD2TALK1  dialog guard
  ...
  {SPR_MISG,0,1,A_WeaponReady,S_GRENADEW}, // S_GRENADEW
  {SPR_MISG,0,1,A_Lower,S_GRENADEDOWN}, // S_GRENADEDOWN
  {SPR_MISG,0,1,A_Raise,S_GRENADEUP}, // S_GRENADEUP
  {SPR_MISG,1,8,A_GunFlash,S_GRENADE2}, // S_GRENADE1
  {SPR_MISG,1,12,A_FireGrenade,S_GRENADE3}, // S_GRENADE2
  {SPR_MISG,1,0,A_ReFire,S_GRENADEW},  // S_GRENADE3
  {SPR_MISF,32768,3,A_Light1,S_GRENADEFLASH2},  // S_GRENADEFLASH1
  {SPR_MISF,32769,4,NULL,S_GRENADEFLASH3},  // S_GRENADEFLASH2
  {SPR_MISF,32770,4,A_Light2,S_GRENADEFLASH4},  // S_GRENADEFLASH3
  {SPR_MISF,32771,4,A_Light2,S_LIGHTDONE},  // S_GRENADEFLASH4
  {SPR_GRLN,0,-1,NULL,S_NULL}, // S_GRNDLAUNCHER
  {SPR_GRNP,0,-1,NULL,S_NULL}, // S_GRENADEPICKUP
  ...
  {SPR_ABK1,0,-1,NULL,S_NULL}, // S_NECRONOMICON_A
  {SPR_KEY1,0,-1,NULL,S_NULL}, // S_KEY1
  {SPR_KEY2,0,-1,NULL,S_NULL}, // S_KEY2
  {SPR_KEY3,0,-1,NULL,S_NULL}, // S_KEY3
  {SPR_KEY4,0,-1,NULL,S_NULL}, // S_KEY4 
  {SPR_KEY5,0,-1,NULL,S_NULL}, // S_KEY5
  {SPR_KEY6,0,-1,NULL,S_NULL}, // S_KEY6
  {SPR_KEY7,0,-1,NULL,S_NULL}, // S_KEY7
  {SPR_KEY8,0,-1,NULL,S_NULL}, // S_KEY8
  {SPR_KEY9,0,-1,NULL,S_NULL}, // S_KEY9
  {SPR_KEYA,0,-1,NULL,S_NULL}, // S_KEYA
  {SPR_KEYB,0,-1,NULL,S_NULL}, // S_KEYB
  ...
  {SPR_TNT1,0,100,A_AmbSound,S_SND_CHAINS}, // S_SND_CHAINS
  {SPR_TNT1,0,100,A_AmbSound,S_SND_GONG},   // S_SND_GONG
  {SPR_TNT1,0,100,A_AmbSound,S_SND_LAVA},   // S_SND_LAVA
  {SPR_TNT1,0,100,A_AmbSound,S_SND_AMB1},   // S_SND_AMB1
  {SPR_FX15,32768,5,A_MummyHeadScream,S_MUMHEAD_2}, // S_MUMHEAD_1
  {SPR_FX15,32769,5,NULL,S_MUMHEAD_3}, // S_MUMHEAD_2
  {SPR_FX15,32770,5,NULL,S_MUMHEAD_1}, // S_MUMHEAD_3
  {SPR_FX15,32771,5,NULL,S_MUMHEAD_X2}, // S_MUMHEAD_X1
  {SPR_FX15,32772,5,NULL,S_MUMHEAD_X3}, // S_MUMHEAD_X2
  {SPR_FX15,32773,5,NULL,S_MUMHEAD_X4}, // S_MUMHEAD_X3
  {SPR_FX15,32774,5,NULL,S_NULL},       // S_MUMHEAD_X4
  {SPR_MUMM,0,10,A_Look,S_MUMMY_STAND2}, // S_MUMMY_STAND1
  {SPR_MUMM,1,10,A_Look,S_MUMMY_STAND1}, // S_MUMMY_STAND2
  {SPR_MUMM,0,4,A_DwarfAlterEgoChase,S_MUMMY_WALK2},  // S_MUMMY_WALK1
  {SPR_MUMM,1,4,A_DwarfAlterEgoChase,S_MUMMY_WALK3},  // S_MUMMY_WALK2
  {SPR_MUMM,2,4,A_DwarfAlterEgoChase,S_MUMMY_WALK4},  // S_MUMMY_WALK3
  {SPR_MUMM,3,4,A_DwarfAlterEgoChase,S_MUMMY_WALK1},  // S_MUMMY_WALK4
  {SPR_MUMM,20,5,A_FaceTarget,S_MUMMY_ATK2}, // S_MUMMY_ATK1
  {SPR_MUMM,32789,5,A_FaceTarget,S_MUMMY_ATK3}, // S_MUMMY_ATK2
  {SPR_MUMM,20,5,A_FaceTarget,S_MUMMY_ATK4}, // S_MUMMY_ATK3
  {SPR_MUMM,32789,5,A_FaceTarget,S_MUMMY_ATK5}, // S_MUMMY_ATK4
  {SPR_MUMM,20,5,A_FaceTarget,S_MUMMY_ATK6}, // S_MUMMY_ATK5
  {SPR_MUMM,32789,15,A_MummyAttack,S_MUMMY_WALK1}, // S_MUMMY_ATK6
  {SPR_MUMM,4,4,NULL,S_MUMMY_PAIN2}, // S_MUMMY_PAIN1
  {SPR_MUMM,4,4,A_Pain,S_MUMMY_WALK1}, // S_MUMMY_PAIN2
  {SPR_MUMM,5,5,NULL,S_MUMMY_DIE2}, // S_MUMMY_DIE1
  {SPR_MUMM,6,5,A_Scream,S_MUMMY_DIE3}, // S_MUMMY_DIE2
  {SPR_MUMM,7,5,A_MummySoul,S_MUMMY_DIE4}, // S_MUMMY_DIE3
  {SPR_MUMM,8,5,NULL,S_MUMMY_DIE5}, // S_MUMMY_DIE4
  {SPR_MUMM,9,5,A_Fall,S_MUMMY_DIE6}, // S_MUMMY_DIE5
  {SPR_MUMM,10,5,NULL,S_MUMMY_DIE7},  // S_MUMMY_DIE6
  {SPR_MUMM,11,5,NULL,S_MUMMY_DIE8},  // S_MUMMY_DIE7
  {SPR_MUMM,12,-1,NULL,S_NULL},       // S_MUMMY_DIE8
  {SPR_MUMM,13,5,NULL,S_MUMMY_SOUL2}, // S_MUMMY_SOUL1
  {SPR_MUMM,14,5,NULL,S_MUMMY_SOUL3}, // S_MUMMY_SOUL2
  {SPR_MUMM,15,5,NULL,S_MUMMY_SOUL4}, // S_MUMMY_SOUL3
  {SPR_MUMM,16,9,NULL,S_MUMMY_SOUL5}, // S_MUMMY_SOUL4
  {SPR_MUMM,17,5,NULL,S_MUMMY_SOUL6}, // S_MUMMY_SOUL5
  {SPR_MUMM,18,5,NULL,S_MUMMY_SOUL7}, // S_MUMMY_SOUL6
  {SPR_MUMM,19,5,NULL,S_NULL},        // S_MUMMY_SOUL7
...
// joel: new COD objects
  {SPR_RCK1,0,-1,NULL,S_NULL,0,0},  // S_COD_ROCK1
  {SPR_TRE3,0,-1,NULL,S_NULL,0,0},    // S_COD_TREE1

// joel: Holy Cross
  {SPR_CROS,0,1,A_WeaponReady,S_CROSS,0,0}, // S_CROSS
  {SPR_CROS,0,1,A_Lower,S_CROSSDOWN,0,0}, // S_CROSSDOWN
  {SPR_CROS,0,1,A_Raise,S_CROSSUP,0,0}, // S_CROSSUP
  {SPR_CROS,1,4,NULL,S_CROSS2,0,0},   // S_CROSS1
  {SPR_CROS,2,4,A_Cross,S_CROSS3,0,0},  // S_CROSS2
  {SPR_CROS,3,5,NULL,S_CROSS4,0,0},   // S_CROSS3
  {SPR_CROS,2,4,NULL,S_CROSS5,0,0},   // S_CROSS4
  {SPR_CROS,1,5,A_ReFire,S_CROSS,0,0},  // S_CROSS5
  {SPR_CRSS,0,-1,NULL,S_NULL,0,0},  // S_CRSS

// joel: new Cyberdemon states
  {SPR_CYBR,0,10,A_Look,S_CCYBER_STND2,0,0}, // S_CCYBER_STND
  {SPR_CYBR,1,10,A_Look,S_CCYBER_STND,0,0},  // S_CCYBER_STND2
  {SPR_CYBR,0,3,A_Hoof,S_CCYBER_RUN2,0,0}, // S_CCYBER_RUN1
  {SPR_CYBR,0,3,A_Chase,S_CCYBER_RUN3,0,0},  // S_CCYBER_RUN2
  {SPR_CYBR,1,3,A_Chase,S_CCYBER_RUN4,0,0},  // S_CCYBER_RUN3
  {SPR_CYBR,1,3,A_Chase,S_CCYBER_RUN5,0,0},  // S_CCYBER_RUN4
  {SPR_CYBR,2,3,A_Chase,S_CCYBER_RUN6,0,0},  // S_CCYBER_RUN5
  {SPR_CYBR,2,3,A_Chase,S_CCYBER_RUN7,0,0},  // S_CCYBER_RUN6
  {SPR_CYBR,3,3,A_Metal,S_CCYBER_RUN8,0,0},  // S_CCYBER_RUN7
  {SPR_CYBR,3,3,A_Chase,S_CCYBER_RUN1,0,0},  // S_CCYBER_RUN8
  {SPR_CYBR,4,6,A_FaceTarget,S_CCYBER_ATK2,0,0}, // S_CCYBER_ATK1
  {SPR_CYBR,5,12,A_CyberAttack,S_CCYBER_ATK3,0,0}, // S_CCYBER_ATK2
  {SPR_CYBR,4,12,A_FaceTarget,S_CCYBER_ATK4,0,0},  // S_CCYBER_ATK3
  {SPR_CYBR,5,12,A_CyberAttack,S_CCYBER_ATK5,0,0}, // S_CCYBER_ATK4
  {SPR_CYBR,4,12,A_FaceTarget,S_CCYBER_ATK6,0,0},  // S_CCYBER_ATK5
  {SPR_CYBR,5,12,A_CCyberAttack3,S_CCYBER_RUN1,0,0}, // S_CCYBER_ATK6
  {SPR_CYBR,6,10,A_Pain,S_CCYBER_RUN1,0,0},  // S_CCYBER_PAIN
  {SPR_CYBR,7,10,NULL,S_CCYBER_DIE2,0,0},  // S_CCYBER_DIE1
  {SPR_CYBR,8,10,A_Scream,S_CCYBER_DIE3,0,0},  // S_CCYBER_DIE2
  {SPR_CYBR,9,10,NULL,S_CCYBER_DIE4,0,0},  // S_CCYBER_DIE3
  {SPR_CYBR,10,10,NULL,S_CCYBER_DIE5,0,0}, // S_CCYBER_DIE4
  {SPR_CYBR,11,10,NULL,S_CCYBER_DIE6,0,0}, // S_CCYBER_DIE5
  {SPR_CYBR,12,10,A_Fall,S_CCYBER_DIE7,0,0}, // S_CCYBER_DIE6
  {SPR_CYBR,13,10,NULL,S_CCYBER_DIE8,0,0}, // S_CCYBER_DIE7
  {SPR_CYBR,14,10,NULL,S_CCYBER_DIE9,0,0}, // S_CCYBER_DIE8
  {SPR_CYBR,15,30,NULL,S_CCYBER_DIE10,0,0},  // S_CCYBER_DIE9
  {SPR_CYBR,15,-1,A_BossDeath,S_NULL,0,0},  // S_CCYBER_DIE10

// joel: new Archvile states
  {SPR_VILE,0,10,A_Look,S_CVILE_STND2,0,0},  // S_CVILE_STND
  {SPR_VILE,1,10,A_Look,S_CVILE_STND,0,0}, // S_CVILE_STND2
  {SPR_VILE,0,2,A_VileChase,S_CVILE_RUN2,0,0}, // S_CVILE_RUN1
  {SPR_VILE,0,2,A_VileChase,S_CVILE_RUN3,0,0}, // S_CVILE_RUN2
  {SPR_VILE,1,2,A_VileChase,S_CVILE_RUN4,0,0}, // S_CVILE_RUN3
  {SPR_VILE,1,2,A_VileChase,S_CVILE_RUN5,0,0}, // S_CVILE_RUN4
  {SPR_VILE,2,2,A_VileChase,S_CVILE_RUN6,0,0}, // S_CVILE_RUN5
  {SPR_VILE,2,2,A_VileChase,S_CVILE_RUN7,0,0}, // S_CVILE_RUN6
  {SPR_VILE,3,2,A_VileChase,S_CVILE_RUN8,0,0}, // S_CVILE_RUN7
  {SPR_VILE,3,2,A_VileChase,S_CVILE_RUN9,0,0}, // S_CVILE_RUN8
  {SPR_VILE,4,2,A_VileChase,S_CVILE_RUN10,0,0},  // S_CVILE_RUN9
  {SPR_VILE,4,2,A_VileChase,S_CVILE_RUN11,0,0},  // S_CVILE_RUN10
  {SPR_VILE,5,2,A_VileChase,S_CVILE_RUN12,0,0},  // S_CVILE_RUN11
  {SPR_VILE,5,2,A_VileChase,S_CVILE_RUN1,0,0}, // S_CVILE_RUN12
  {SPR_VILE,32774,0,A_VileStart,S_CVILE_ATK2,0,0}, // S_CVILE_ATK1
  {SPR_VILE,32774,10,A_FaceTarget,S_CVILE_ATK3,0,0}, // S_CVILE_ATK2
  {SPR_VILE,32775,8,A_VileTarget,S_CVILE_ATK4,0,0},  // S_CVILE_ATK3
  {SPR_VILE,32776,8,A_FaceTarget,S_CVILE_ATK5,0,0},  // S_CVILE_ATK4
  {SPR_VILE,32777,8,A_FaceTarget,S_CVILE_ATK6,0,0},  // S_CVILE_ATK5
  {SPR_VILE,32778,8,A_FaceTarget,S_CVILE_ATK7,0,0},  // S_CVILE_ATK6
  {SPR_VILE,32779,8,A_FaceTarget,S_CVILE_ATK8,0,0},  // S_CVILE_ATK7
  {SPR_VILE,32780,8,A_FaceTarget,S_CVILE_ATK9,0,0},  // S_CVILE_ATK8
  {SPR_VILE,32781,8,A_FaceTarget,S_CVILE_ATK10,0,0}, // S_CVILE_ATK9
  {SPR_VILE,32782,8,A_CVileAttack,S_CVILE_ATK11,0,0}, // S_CVILE_ATK10
  {SPR_VILE,32783,20,NULL,S_CVILE_RUN1,0,0}, // S_CVILE_ATK11
  {SPR_VILE,32794,10,NULL,S_CVILE_HEAL2,0,0},  // S_CVILE_HEAL1
  {SPR_VILE,32795,10,NULL,S_CVILE_HEAL3,0,0},  // S_CVILE_HEAL2
  {SPR_VILE,32796,10,NULL,S_CVILE_RUN1,0,0}, // S_CVILE_HEAL3
  {SPR_VILE,16,5,NULL,S_CVILE_PAIN2,0,0},  // S_CVILE_PAIN
  {SPR_VILE,16,5,A_Pain,S_CVILE_RUN1,0,0}, // S_CVILE_PAIN2
  {SPR_VILE,16,7,NULL,S_CVILE_DIE2,0,0}, // S_CVILE_DIE1
  {SPR_VILE,17,7,A_Scream,S_CVILE_DIE3,0,0},  // S_CVILE_DIE2
  {SPR_VILE,18,7,A_Fall,S_CVILE_DIE4,0,0}, // S_CVILE_DIE3
  {SPR_VILE,19,7,NULL,S_CVILE_DIE5,0,0}, // S_CVILE_DIE4
  {SPR_VILE,20,7,NULL,S_CVILE_DIE6,0,0}, // S_CVILE_DIE5
  {SPR_VILE,21,7,NULL,S_CVILE_DIE7,0,0}, // S_CVILE_DIE6
  {SPR_VILE,22,7,NULL,S_CVILE_DIE8,0,0}, // S_CVILE_DIE7
  {SPR_VILE,23,5,NULL,S_CVILE_DIE9,0,0}, // S_CVILE_DIE8
  {SPR_VILE,24,5,NULL,S_CVILE_DIE10,0,0},  // S_CVILE_DIE9
...
// joel: ambient sounds
  ...
  {SPR_POSS,4,8,NULL,S_POSS_RUN1},  // S_HardAssZombieman_ATK3

  {SPR_POSS,7,5,NULL,S_TRIGGERPOSS_DIE2},  // S_TRIGGERPOSS_DIE1
  {SPR_POSS,8,5,A_Scream,S_TRIGGERPOSS_DIE3},  // S_TRIGGERPOSS_DIE2
  {SPR_POSS,9,5,A_Fall,S_TRIGGERPOSS_DIE4},  // S_TRIGGERPOSS_DIE3
  {SPR_POSS,10,5,NULL,S_TRIGGERPOSS_DIE5}, // S_TRIGGERPOSS_DIE4
  {SPR_POSS,11,-1,A_Legion,S_NULL}, // S_TRIGGERPOSS_DIE5

  {SPR_SPOS,7,5,NULL,S_TRIGGERSPOS_DIE2},  // S_TRIGGERSPOS_DIE1
  {SPR_SPOS,8,5,A_Scream,S_TRIGGERSPOS_DIE3},  // S_TRIGGERSPOS_DIE2
  {SPR_SPOS,9,5,A_Fall,S_TRIGGERSPOS_DIE4},  // S_TRIGGERSPOS_DIE3
  {SPR_SPOS,10,5,NULL,S_TRIGGERSPOS_DIE5}, // S_TRIGGERSPOS_DIE4
  {SPR_SPOS,11,-1,A_Legion,S_NULL}, // S_TRIGGERSPOS_DIE5

  {SPR_SARG,8,8,NULL,S_TRIGGERSARG_DIE2},  // S_TRIGGERSARG_DIE1
  {SPR_SARG,9,8,A_Scream,S_TRIGGERSARG_DIE3},  // S_TRIGGERSARG_DIE2
  {SPR_SARG,10,4,NULL,S_TRIGGERSARG_DIE4}, // S_TRIGGERSARG_DIE3
  {SPR_SARG,11,4,A_Fall,S_TRIGGERSARG_DIE5}, // S_TRIGGERSARG_DIE4
  {SPR_SARG,12,4,NULL,S_TRIGGERSARG_DIE6}, // S_TRIGGERSARG_DIE5
  {SPR_SARG,13,-1,A_Legion,S_NULL}, // S_TRIGGERSARG_DIE6

  {SPR_TROO,8,8,NULL,S_TRIGGERTROO_DIE2},  // S_TRIGGERTROO_DIE1
  {SPR_TROO,9,8,A_Scream,S_TRIGGERTROO_DIE3},  // S_TRIGGERTROO_DIE2
  {SPR_TROO,10,6,NULL,S_TRIGGERTROO_DIE4}, // S_TRIGGERTROO_DIE3
  {SPR_TROO,11,6,A_Fall,S_TRIGGERTROO_DIE5}, // S_TRIGGERTROO_DIE4
  {SPR_TROO,12,-1,A_Legion,S_NULL}, // S_TRIGGERTROO_DIE5

// joel: spec & demon states the same

  {SPR_SKUL,32773,6,NULL,S_TRIGGERSKULL_DIE2}, // S_TRIGGERSKULL_DIE1
  {SPR_SKUL,32774,6,A_Scream,S_TRIGGERSKULL_DIE3}, // S_TRIGGERSKULL_DIE2
  {SPR_SKUL,32775,6,NULL,S_TRIGGERSKULL_DIE4}, // S_TRIGGERSKULL_DIE3
  {SPR_SKUL,32776,6,A_Fall,S_TRIGGERSKULL_DIE5}, // S_TRIGGERSKULL_DIE4
  {SPR_SKUL,9,6,NULL,S_TRIGGERSKULL_DIE6}, // S_TRIGGERSKULL_DIE5
  {SPR_SKUL,10,6,A_Legion,S_NULL},  // S_TRIGGERSKULL_DIE6

  {SPR_HEAD,6,8,NULL,S_TRIGGERHEAD_DIE2},  // S_TRIGGERHEAD_DIE1
  {SPR_HEAD,7,8,A_Scream,S_TRIGGERHEAD_DIE3},  // S_TRIGGERHEAD_DIE2
  {SPR_HEAD,8,8,NULL,S_TRIGGERHEAD_DIE4},  // S_TRIGGERHEAD_DIE3
  {SPR_HEAD,9,8,NULL,S_TRIGGERHEAD_DIE5},  // S_TRIGGERHEAD_DIE4
  {SPR_HEAD,10,8,A_Fall,S_TRIGGERHEAD_DIE6}, // S_TRIGGERHEAD_DIE5
  {SPR_HEAD,11,-1,A_Legion,S_NULL}, // S_TRIGGERHEAD_DIE6

  {SPR_BOSS,8,8,NULL,S_TRIGGERBOSS_DIE2},  // S_TRIGGERBOSS_DIE1
  {SPR_BOSS,9,8,A_Scream,S_TRIGGERBOSS_DIE3},  // S_TRIGGERBOSS_DIE2
  {SPR_BOSS,10,8,NULL,S_TRIGGERBOSS_DIE4}, // S_TRIGGERBOSS_DIE3
  {SPR_BOSS,11,8,A_Fall,S_TRIGGERBOSS_DIE5}, // S_TRIGGERBOSS_DIE4
  {SPR_BOSS,12,8,NULL,S_TRIGGERBOSS_DIE6}, // S_TRIGGERBOSS_DIE5
  {SPR_BOSS,13,8,NULL,S_TRIGGERBOSS_DIE7}, // S_TRIGGERBOSS_DIE6
  {SPR_BOSS,14,-1,A_Legion,S_NULL},  // S_TRIGGERBOSS_DIE7

  {SPR_CYBR,7,10,NULL,S_TRIGGERCYBER_DIE2},  // S_TRIGGERCYBER_DIE1
  {SPR_CYBR,8,10,A_Scream,S_TRIGGERCYBER_DIE3},  // S_TRIGGERCYBER_DIE2
  {SPR_CYBR,9,10,NULL,S_TRIGGERCYBER_DIE4},  // S_TRIGGERCYBER_DIE3
  {SPR_CYBR,10,10,NULL,S_TRIGGERCYBER_DIE5}, // S_TRIGGERCYBER_DIE4
  {SPR_CYBR,11,10,NULL,S_TRIGGERCYBER_DIE6}, // S_TRIGGERCYBER_DIE5
  {SPR_CYBR,12,10,A_Fall,S_TRIGGERCYBER_DIE7}, // S_TRIGGERCYBER_DIE6
  {SPR_CYBR,13,10,NULL,S_TRIGGERCYBER_DIE8}, // S_TRIGGERCYBER_DIE7
  {SPR_CYBR,14,10,NULL,S_TRIGGERCYBER_DIE9}, // S_TRIGGERCYBER_DIE8
  {SPR_CYBR,15,30,NULL,S_TRIGGERCYBER_DIE10},  // S_TRIGGERCYBER_DIE9
  {SPR_CYBR,15,-1,A_Legion,S_NULL},  // S_TRIGGERCYBER_DIE10

  {SPR_SPID,9,20,A_Scream,S_TRIGGERSPID_DIE2}, // S_TRIGGERSPID_DIE1
  {SPR_SPID,10,10,A_Fall,S_TRIGGERSPID_DIE3},  // S_TRIGGERSPID_DIE2
  {SPR_SPID,11,10,NULL,S_TRIGGERSPID_DIE4},  // S_TRIGGERSPID_DIE3
  {SPR_SPID,12,10,NULL,S_TRIGGERSPID_DIE5},  // S_TRIGGERSPID_DIE4
  {SPR_SPID,13,10,NULL,S_TRIGGERSPID_DIE6},  // S_TRIGGERSPID_DIE5
  {SPR_SPID,14,10,NULL,S_TRIGGERSPID_DIE7},  // S_TRIGGERSPID_DIE6
  {SPR_SPID,15,10,NULL,S_TRIGGERSPID_DIE8},  // S_TRIGGERSPID_DIE7
  {SPR_SPID,16,10,NULL,S_TRIGGERSPID_DIE9},  // S_TRIGGERSPID_DIE8
  {SPR_SPID,17,10,NULL,S_TRIGGERSPID_DIE10}, // S_TRIGGERSPID_DIE9
  {SPR_SPID,18,30,NULL,S_TRIGGERSPID_DIE11}, // S_TRIGGERSPID_DIE10
  {SPR_SPID,18,-1,A_Legion,S_NULL},  // S_TRIGGERSPID_DIE11

  {SPR_CPOS,7,5,NULL,S_TRIGGERCPOS_DIE2},  // S_TRIGGERCPOS_DIE1
  {SPR_CPOS,8,5,A_Scream,S_TRIGGERCPOS_DIE3},  // S_TRIGGERCPOS_DIE2
  {SPR_CPOS,9,5,A_Fall,S_TRIGGERCPOS_DIE4},  // S_TRIGGERCPOS_DIE3
  {SPR_CPOS,10,5,NULL,S_TRIGGERCPOS_DIE5}, // S_TRIGGERCPOS_DIE4
  {SPR_CPOS,11,5,NULL,S_TRIGGERCPOS_DIE6}, // S_TRIGGERCPOS_DIE5
  {SPR_CPOS,12,5,NULL,S_TRIGGERCPOS_DIE7}, // S_TRIGGERCPOS_DIE6
  {SPR_CPOS,13,-1,A_Legion,S_NULL}, // S_TRIGGERCPOS_DIE7

  {SPR_BOS2,8,8,NULL,S_TRIGGERBOS2_DIE2},  // S_TRIGGERBOS2_DIE1
  {SPR_BOS2,9,8,A_Scream,S_TRIGGERBOS2_DIE3},  // S_TRIGGERBOS2_DIE2
  {SPR_BOS2,10,8,NULL,S_TRIGGERBOS2_DIE4}, // S_TRIGGERBOS2_DIE3
  {SPR_BOS2,11,8,A_Fall,S_TRIGGERBOS2_DIE5}, // S_TRIGGERBOS2_DIE4
  {SPR_BOS2,12,8,NULL,S_TRIGGERBOS2_DIE6}, // S_TRIGGERBOS2_DIE5
  {SPR_BOS2,13,8,NULL,S_TRIGGERBOS2_DIE7}, // S_TRIGGERBOS2_DIE6
  {SPR_BOS2,14,-1,A_Legion,S_NULL}, // S_TRIGGERBOS2_DIE7

  {SPR_BSPI,9,20,A_Scream,S_TRIGGERBSPI_DIE2}, // S_TRIGGERBSPI_DIE1
  {SPR_BSPI,10,7,A_Fall,S_TRIGGERBSPI_DIE3}, // S_TRIGGERBSPI_DIE2
  {SPR_BSPI,11,7,NULL,S_TRIGGERBSPI_DIE4}, // S_TRIGGERBSPI_DIE3
  {SPR_BSPI,12,7,NULL,S_TRIGGERBSPI_DIE5}, // S_TRIGGERBSPI_DIE4
  {SPR_BSPI,13,7,NULL,S_TRIGGERBSPI_DIE6}, // S_TRIGGERBSPI_DIE5
  {SPR_BSPI,14,7,NULL,S_TRIGGERBSPI_DIE7}, // S_TRIGGERBSPI_DIE6
  {SPR_BSPI,15,-1,A_Legion,S_NULL},  // S_TRIGGERBSPI_DIE7

  {SPR_PAIN,32775,8,NULL,S_TRIGGERPAIN_DIE2},  // S_TRIGGERPAIN_DIE1
  {SPR_PAIN,32776,8,A_Scream,S_TRIGGERPAIN_DIE3},  // S_TRIGGERPAIN_DIE2
  {SPR_PAIN,32777,8,NULL,S_TRIGGERPAIN_DIE4},  // S_TRIGGERPAIN_DIE3
  {SPR_PAIN,32778,8,NULL,S_TRIGGERPAIN_DIE5},  // S_TRIGGERPAIN_DIE4
  {SPR_PAIN,32779,8,A_PainDie,S_TRIGGERPAIN_DIE6}, // S_TRIGGERPAIN_DIE5
  {SPR_PAIN,32780,8,A_Legion,S_NULL}, // S_TRIGGERPAIN_DIE6

  {SPR_SKEL,11,7,NULL,S_TRIGGERSKEL_DIE2}, // S_TRIGGERSKEL_DIE1
  {SPR_SKEL,12,7,NULL,S_TRIGGERSKEL_DIE3}, // S_TRIGGERSKEL_DIE2
  {SPR_SKEL,13,7,A_Scream,S_TRIGGERSKEL_DIE4}, // S_TRIGGERSKEL_DIE3
  {SPR_SKEL,14,7,A_Fall,S_TRIGGERSKEL_DIE5}, // S_TRIGGERSKEL_DIE4
  {SPR_SKEL,15,7,NULL,S_TRIGGERSKEL_DIE6}, // S_TRIGGERSKEL_DIE5
  {SPR_SKEL,16,-1,A_Legion,S_NULL}, // S_TRIGGERSKEL_DIE6

  {SPR_FATT,10,6,NULL,S_TRIGGERFATT_DIE2}, // S_TRIGGERFATT_DIE1
  {SPR_FATT,11,6,A_Scream,S_TRIGGERFATT_DIE3}, // S_TRIGGERFATT_DIE2
  {SPR_FATT,12,6,A_Fall,S_TRIGGERFATT_DIE4}, // S_TRIGGERFATT_DIE3
  {SPR_FATT,13,6,NULL,S_TRIGGERFATT_DIE5}, // S_TRIGGERFATT_DIE4
  {SPR_FATT,14,6,NULL,S_TRIGGERFATT_DIE6}, // S_TRIGGERFATT_DIE5
  {SPR_FATT,15,6,NULL,S_TRIGGERFATT_DIE7}, // S_TRIGGERFATT_DIE6
  {SPR_FATT,16,6,NULL,S_TRIGGERFATT_DIE8}, // S_TRIGGERFATT_DIE7
  {SPR_FATT,17,6,NULL,S_TRIGGERFATT_DIE9}, // S_TRIGGERFATT_DIE8
  {SPR_FATT,18,6,NULL,S_TRIGGERFATT_DIE10},  // S_TRIGGERFATT_DIE9
  {SPR_FATT,19,-1,A_Legion,S_NULL},  // S_TRIGGERFATT_DIE10
// joel - new COD baron states
  {SPR_BOSS,14,-1,A_Look,S_CBOSS_STND2},  // S_CBOSS_STND
  {SPR_BOSS,14,-1,A_Look,S_CBOSS_STND}, // S_CBOSS_STND2
  {SPR_BOSS,0,3,A_Chase,S_CBOSS_RUN2}, // S_CBOSS_RUN1
  {SPR_BOSS,0,3,A_Chase,S_CBOSS_RUN3}, // S_CBOSS_RUN2
  {SPR_BOSS,1,3,A_Chase,S_CBOSS_RUN4}, // S_CBOSS_RUN3
  {SPR_BOSS,1,3,A_Chase,S_CBOSS_RUN5}, // S_CBOSS_RUN4
  {SPR_BOSS,2,3,A_Chase,S_CBOSS_RUN6}, // S_CBOSS_RUN5
  {SPR_BOSS,2,3,A_Chase,S_CBOSS_RUN7}, // S_CBOSS_RUN6
  {SPR_BOSS,3,3,A_Chase,S_CBOSS_RUN8}, // S_CBOSS_RUN7
  {SPR_BOSS,3,3,A_Chase,S_CBOSS_RUN1}, // S_CBOSS_RUN8
  {SPR_BOSS,4,8,A_FaceTarget,S_CBOSS_ATK2},  // S_CBOSS_ATK1
  {SPR_BOSS,5,8,A_FaceTarget,S_CBOSS_ATK3},  // S_CBOSS_ATK2
  {SPR_BOSS,6,8,A_BruisAttack,S_CBOSS_RUN1}, // S_CBOSS_ATK3
  {SPR_BOSS,7,2,NULL,S_CBOSS_PAIN2}, // S_CBOSS_PAIN
  {SPR_BOSS,7,2,A_Pain,S_CBOSS_RUN1},  // S_CBOSS_PAIN2
  {SPR_BOSS,8,8,NULL,S_CBOSS_DIE2},  // S_CBOSS_DIE1
  {SPR_BOSS,9,8,A_Scream,S_CBOSS_DIE3},  // S_CBOSS_DIE2
  {SPR_BOSS,10,8,NULL,S_CBOSS_DIE4}, // S_CBOSS_DIE3
  {SPR_BOSS,11,8,A_Fall,S_CBOSS_DIE5}, // S_CBOSS_DIE4
  {SPR_BOSS,12,8,NULL,S_CBOSS_DIE6}, // S_CBOSS_DIE5
  {SPR_BOSS,13,8,NULL,S_CBOSS_DIE7}, // S_CBOSS_DIE6
  {SPR_BOSS,14,-1,A_BossDeath,S_NULL},  // S_CBOSS_DIE7
  {SPR_BOSS,14,8,NULL,S_CBOSS_RAISE2}, // S_CBOSS_RAISE1
  {SPR_BOSS,13,8,NULL,S_CBOSS_RAISE3}, // S_CBOSS_RAISE2
  {SPR_BOSS,12,8,NULL,S_CBOSS_RAISE4}, // S_CBOSS_RAISE3
  {SPR_BOSS,11,8,NULL,S_CBOSS_RAISE5}, // S_CBOSS_RAISE4
...
mobjinfo_t mobjinfo[NUMMOBJTYPES] = {
  ...
  {   // MT_VILE
    ...
    MF_SOLID|MF_SHOOTABLE|MF_COUNTKILL,   // flags
    MF2_SHORTMRANGE,  // flags2 -- haleyjd 01/09/02
    S_NULL    // raisestate
  },
  ...
  {   // MT_UNDEAD
    ...
    MF_SOLID|MF_SHOOTABLE|MF_COUNTKILL,  // flags
    MF2_LONGMELEE | MF2_RANGEHALF, // flags2 -- haleyjd 01/09/02
  ...
  {   // MT_FATSO
    ...
    sfx_posact,   // activesound
    MF_SOLID|MF_SHOOTABLE|MF_COUNTKILL,   // flags
    MF2_MAP07BOSS1, // flags2 -- haleyjd 01/09/02
  ...
  {   // MT_BRUISER
    ...
    sfx_dmact,    // activesound
    MF_SOLID|MF_SHOOTABLE|MF_COUNTKILL,   // flags
    MF2_E1M8BOSS,  // flags2 -- haleyjd 01/09/02
  ...
  {   // MT_SPIDER
    ...
    sfx_dmact,    // activesound
    MF_SOLID|MF_SHOOTABLE|MF_COUNTKILL,   // flags
    MF2_BOSS|MF2_RANGEHALF|MF2_E3M8BOSS|MF2_E4M8BOSS, // flags2
    S_NULL    // raisestate
  },
  ...
  {   // MT_CYBORG
    ...
    sfx_dmact,    // activesound
    MF_SOLID|MF_SHOOTABLE|MF_COUNTKILL,   // flags
    MF2_BOSS|MF2_RANGEHALF|MF2_HIGHERMPROB|MF2_E2M8BOSS|MF2_E4M6BOSS, // flags2
    S_NULL    // raisestate
  },
  ...
  { // haleyjd 1/26/99: Ambient Sounds -- MT_SNDWIND
    7001,               // doomednum -- ambients start at 7001
  ...
  { // MT_TRE3
    ...
    sfx_None,           // deathsound
    0,                  // speed
    10*FRACUNIT,        // radius (tweak this stuff)
    150*FRACUNIT,       // height
    100,                // mass
    0,                  // damage
    sfx_None,           // activesound
    MF_SOLID,           // flags
    MF2_NOTHRUST,       // these need to be uncarryable
    S_NULL              // raisestate
  },
  ...
  { // MT_TRDT   destructable tree
    6005,               // doomednum
    S_TRDT_1,           // spawnstate
    30,                 // spawnhealth (tweak)
    S_NULL,             // seestate
    sfx_None,           // seesound
    8,                  // reactiontime
    sfx_None,           // attacksound
    ...
    S_NULL,             // meleestate
    S_NULL,             // missilestate
    S_TRDT_DTH1,        // deathstate
    S_NULL,             // xdeathstate
    sfx_trebrk,         // deathsound
    0,                  // speed
    15*FRACUNIT,        // radius
    180*FRACUNIT,       // height
    10000000,           // mass (ain't goin' NO where)
    0,                  // damage
    sfx_None,           // activesound
    MF_SOLID | MF_SHOOTABLE | MF_NOBLOOD,  // flags
    0,
  ...
  {  // MT_NEWCORPSE1
    6034,               // doomednum
    S_CORPSEHANGINGMANGLED,          // spawnstate
    1000,               // spawnhealth
    S_NULL,             // seestate
    sfx_None,           // seesound
    8,                  // reactiontime
  ...
  {   // MT_DWARF
    ...
    sfx_None,   // activesound
    MF_SOLID | MF_SHOOTABLE | MF_COUNTKILL,  // flags
    MF2_ALWAYSRESPAWN | MF2_JUMPDOWN, // flags2
    S_NULL    // raisestate
  },

  {   // MT_DWARFDLG1 -- talking dwarf
    6045,   // doomednum
    S_DWARF1TALK1,   // spawnstate
    1000,   // spawnhealth
    S_NULL,   // seestate
    sfx_None,   // seesound
    8,    // reactiontime
  ...
  {   // MT_CYBERGUARD2
    ...
    sfx_dmact,    // activesound
    MF_SOLID | MF_SHOOTABLE | MF_COUNTKILL,   // flags
    MF2_BOSS | MF2_INVULNERABLE, // haleyjd 04/09/99: flags2
    S_NULL    // raisestate
  },
  ...
  {   // MT_CAMERANODE
    5004,   // doomednum  haleyjd - use next free controller #
    S_NULL,   // spawnstate
    1000,   // spawnhealth
    S_NULL,   // seestate
    sfx_None,   // seesound
...
// joel: New COD bad guys
  ...
  {   // MT_CKNIGHT
    ...
    0,    // damage
    sfx_None,    // activesound
    MF_SOLID|MF_SHOOTABLE|MF_COUNTKILL|MF_NOSECTOR,   // flags
		0, //flags2
    S_BOS2_RAISE1   // raisestate
  },
    ...
    {   // MT_CBRUISER
    5011,   // doomednum
    S_CBOSS_STND,  // spawnstate
    1000,   // spawnhealth
    S_CBOSS_RAISE1,    // seestate
    sfx_brssit,   // seesound
    8,    // reactiontime
    0,    // attacksound
    S_CBOSS_PAIN,    // painstate
    50,   // painchance
    sfx_dmpain,   // painsound
    S_CBOSS_ATK1,    // meleestate
    S_CBOSS_ATK1,    // missilestate
    S_CBOSS_DIE1,    // deathstate
    S_NULL,   // xdeathstate
    sfx_brsdth,   // deathsound
    8,    // speed
    24*FRACUNIT,    // radius
  ...
  {   // MT_CCYBORG
    5014,   // doomednum
    S_CCYBER_STND,   // spawnstate
    4000,   // spawnhealth
    S_CCYBER_RUN1,   // seestate
    sfx_cybsit,   // seesound
    8,    // reactiontime
    0,    // attacksound
    S_CCYBER_PAIN,   // painstate
    20,   // painchance
    sfx_dmpain,   // painsound
    0,    // meleestate
    S_CCYBER_ATK1,   // missilestate
    S_CCYBER_DIE1,   // deathstate
    S_NULL,   // xdeathstate
    sfx_cybdth,   // deathsound
    16,   // speed
    40*FRACUNIT,    // radius
    ...
    sfx_dmact,    // activesound
    MF_SOLID|MF_SHOOTABLE|MF_COUNTKILL,   // flags
    MF2_BOSS, // joel - add James' boss flag for full volume sound
    S_NULL    // raisestate
  },

  {   // MT_CVILE
    5017,   // doomednum
    S_CVILE_STND,    // spawnstate
    700,    // spawnhealth
    S_CVILE_RUN1,    // seestate
    sfx_vilsit,   // seesound
    8,    // reactiontime
    0,    // attacksound
    S_CVILE_PAIN,    // painstate
    10,   // painchance
    sfx_vipain,   // painsound
    0,    // meleestate
    S_CVILE_ATK1,    // missilestate
    S_CVILE_DIE1,    // deathstate
    S_NULL,   // xdeathstate
    sfx_vildth,   // deathsound
    0,   // speed
    20*FRACUNIT,    // radius
...
// joel: ambient sounds
  ...
  {   // HardAssZombieman
    ...
    sfx_popain,   // painsound
    0,    // meleestate
    S_HardAssZombieman_ATK1,    // missilestate
    S_POSS_DIE1,    // deathstate
    S_POSS_XDIE1,   // xdeathstate
    sfx_podth1,   // deathsound
    8,    // speed
...
// joel: now the trigger activators
  {   // NoRes_Trooper
    5029,   // doomednum
    S_POSS_STND,    // spawnstate
    20,   // spawnhealth
  ...
  {   // MT_SKULL
    ...
    0,    // meleestate
    S_SKULL_ATK1,   // missilestate
    S_TRIGGERSKULL_DIE1,   // deathstate
    S_NULL,   // xdeathstate
    sfx_firxpl,   // deathsound
    8,    // speed
    16*FRACUNIT,    // radius
  ...
  {   // MT_CYBORG
    ...
    0,    // meleestate
    S_CYBER_ATK1,   // missilestate
    S_TRIGGERCYBER_DIE1,   // deathstate
    S_NULL,   // xdeathstate
    sfx_cybdth,   // deathsound
    16,   // speed
    40*FRACUNIT,    // radius
