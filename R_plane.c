...
// haleyjd: this is a non-feature, and since this function is
// never called because of the ifdef below, I've ifdef'd it too.
// A solution of my own may come about however...
